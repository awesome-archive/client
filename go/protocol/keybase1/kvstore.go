...
func (o Revision) DeepCopy() Revision {
	return o
}
...
type KVEntry struct {
	...
	Revision   Revision `codec:"revision" json:"revision"`
}
...
type KvstoreInterface interface {
	...
	PutKVEntry(context.Context, PutKVEntryArg) (Revision, error)
}
...
func (c KvstoreClient) PutKVEntry(ctx context.Context, __arg PutKVEntryArg) (res Revision, err error) {
